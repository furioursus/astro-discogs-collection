...
async function downloadImage(url: string, destination: string, userAgent: string): Promise<void> {
...
export async function cacheCoverImages(log: (message: string) => void = () => {}): Promise<CacheImagesResult> {
